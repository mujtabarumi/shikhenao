<footer class="footer">
    ...
    <div class="container">
        ...
        <div class="row footer__content">
            <div class="col-lg-5 col-md-5"><a class="logo__link footer__logo" href="http://swlabs.co/"><img class="logo__image" src="{{url('public/assets/img/logo/Logo-footer.png')}}" alt="Logo Educef"></a>
            ...
            <div class="col-lg-7 col-md-7 footer__content__right">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 footer__item">
                        ...
                        <div class="footer-link__link footer-link__link--phone">help@shikhenao.com</div>
                    </div>
                </div>
            </div>
        </div>
